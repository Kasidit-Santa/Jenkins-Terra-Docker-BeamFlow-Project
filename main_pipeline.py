...
table_spec = (
    'labdap:'
    'kasidit_workshop2.kasidit_dfsqltable_sales'
)
...
pipeline_args = [
    '--project=labdap',  # Change to your GCP project ID
    '--runner=DataflowRunner',
    '--region=us-central1',  # Adjust as per your GCP region
    '--staging_location=gs://kasidit_workshop2/temp/staging/',  # Change to your bucket path
    '--temp_location=gs://kasidit_workshop2/temp',  # Change to your bucket path
    '--streaming',
...
(p 
 | 'Read from PubSub' >> beam.io.ReadFromPubSub(
     topic="projects/labdap/topics/kasidit-transactions"  # Change to your PubSub topic
 )
